...
var _dataServices = _interopRequireDefault(require("./services/dataServices"));
var _dataReturn = require("./services/dataReturn");
var _star = _interopRequireDefault(require("../assets/star1.png"));
var _star2 = _interopRequireDefault(require("../assets/star2.png"));
var _star3 = _interopRequireDefault(require("../assets/star3.png"));
var _star4 = _interopRequireDefault(require("../assets/star4.png"));
...
var WRFooter = function WRFooter() {
  var _useState = (0, _react.useState)([]),
    ...
    projectsList = _useState2[0],
    setProjectsList = _useState2[1];
  (0, _react.useEffect)(function () {
    function getProjects() {
      return _getProjects.apply(this, arguments);
    }
    function _getProjects() {
      _getProjects = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var snapshotProjects, projectsToTable;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _dataServices["default"].getAllDocs('projects', 'projectId', 'desc');
              case 2:
                snapshotProjects = _context.sent;
                projectsToTable = (0, _dataReturn.returnRegistersFromSnapshot)(snapshotProjects, 'projects');
  ...
  return /*#__PURE__*/_react["default"].createElement("footer", {
    ...
    if (item.projectStars == 1) {
      ...
      stars = _star2["default"];
    } else if (item.projectStars == 3) {
      stars = _star3["default"];
    } else if (item.projectStars == 4) {
      stars = _star4["default"];
    }
    return /*#__PURE__*/_react["default"].createElement("p", {
      key: item.projectId,
      style: styles.paragrafo
    }, item.projectId, " - ", item.projectName, " / ", /*#__PURE__*/_react["default"].createElement("img", {
      style: styles.estrelas,
      src: stars
    }), " / ", /*#__PURE__*/_react["default"].createElement("a", {
      href: item.projectSite,
      target: "_blank"
    }, " LINK "), " ");
  }));
};
